  ...
  return (
    <div className="grid grid-rows-[auto_1fr_auto] min-h-screen h-fit">
      ...
      <main className="w-full">
        <section className="flex max-lg:flex-col p-4 ">
          <div className="w-1/2 max-lg:w-full p-10 px-[8%]flex flex-col gap-5 items-start justify-start">
            <h1 className="text-[3em] font-semibold">
              ...
              <span className="text-[#E67505]"><div className="inline relative "><span className="relative z-2">Premium</span> <img src={Vector} className="absolute z-0 top-0 -left-0" /> </div> Event Services</span>
            </h1>
            <p>
