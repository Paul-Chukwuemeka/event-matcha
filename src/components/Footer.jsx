...
const Footer = () => {
  return (
    <div className="bg-[#005F61] w-full py-10 px-20">
      <section className="flex justify-between p-6 gap-50">
        ...
        <div className="text-white flex flex-col gap-4">
          ...
          <div className="flex gap-5">
            <input
              type="text"
              className="bg-white text-lg p-2.5 placeholder:text-[#757575] text-black font-medium rounded-md"
              placeholder="Enter your email"
            />
            <button className="bg-[#F78105] w-28 rounded-lg">Subscribe</button>
          </div>
      ...
      <div className="p-2 mt-8 flex justify-between">
