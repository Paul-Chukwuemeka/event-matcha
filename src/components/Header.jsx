...
const Header = () => {
  return (
    <div className="flex items-center justify-evenly p-4 shadow-[10px_10px_10px] shadow-[#f7820509]">
      ...
      <ul className="flex w-1/4 text-lg justify-between *:hover:text-[#005F61] *:cursor-pointer ">
        <li>Home</li>
        <li>About</li>
